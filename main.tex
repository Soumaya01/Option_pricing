...
\\
 ...
 As we see when N is large the FFT reduces the amount of time that usual DFT takes to perform the option price. we will also see taht it provides an efficient way of computing the previous bound \lab for several values of x at the same time.
