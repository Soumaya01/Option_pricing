...
With the same parameters [$r =5.59 \%,\quad \sigma=17.65\%,\quad  \lambda=8.90\%, \alpha=-88.98\%,\quad  \delta=45.05\%  T=1 year] $ used in Andersen and Andreseasen (2001).
...
For $\eta_1=10$, $\eta_2=5$  , $\lambda=1$, $p=0.4$, $\sigma=0.16$, $r=5\%$, $S(0)=100$, $k=98$ and $T=0.5$
Although an infinite series appears in the formula of $\Upsilon$, the following graphs proves that within  10 to 15 iterations the price converges to the same reference value indicated  in (kou 2002) which is   
9.14732  
\textcolor{blue}{still have a problem with the graph}
