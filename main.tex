...
\begin{equation}
I_n(c,\alpha,\beta,\gamma)=- \frac{e^{-\alpha c}}{\alpha} \big(\frac{\beta}{\alpha}\big)^{n-1}Hh_i(\beta c _ \gamma)+\big(\frac{\beta}{\alpha}\big)^{n+1} \frac{\sqrt{2\pi}}{\beta}e^{\frac{\alpha \delta}{}}{}
\end{equation}
