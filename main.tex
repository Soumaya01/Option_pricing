...
As we know, jumps in the Kou model are double exponentially distributed. Thus, to compute a closed form solution of an option price we need to know the sum of double exponentially random variable.
...
Hh_{-1}(x)=e^{\frac{x^2}{2}}= \sqrt{2\pi \phi(x)} \\
