...
\textcolor{blue}{not the same Juho , this one if for the kou model}
\jcom{Oh, I see. In that case, forget that comment, althought most of the comments that hold for the plot
of merton model are relevant here too.}
...
Now we define a Lévy process $B(t,\theta,\sigma)$ defined in terms of $b(t,\theta,\sigma)$  where the time follows a gamma process $\gamma(t,1,\mu):$
\begin{center}
$B(t,\theta,\sigma)=B(\gamma(t,1,\mu)\theta,\sigma)$
\end{center}
