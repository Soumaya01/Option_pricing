...
\end{center}
 ...
 $H$ $\in  \emph{C}^2$, where $\eta$ depends on N.\\

(Trefethen and Weidman,2013 ) proved that Trapezoidal rule converges exponentially when applied to analytic functions.
