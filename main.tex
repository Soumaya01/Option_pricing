...
\end{center}
 ...
 We can clearly see that the sum in \eqref{fret} is not a direct application of the
FFT algorithm. Thus, we cannot use the FFT algorithm on that summation,
we need to \jcor{modificate}{modify} it.  In general, the strikes near the spot price are of \jcom{???}
